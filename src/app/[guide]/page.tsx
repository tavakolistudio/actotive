...
export async function generateMetadata({ params }: { params: Promise<{ guide: string }> }) { return guideMetadata(await getSlug(params), "en"); }
export default async function Page({ params }: { params: Promise<{ guide: string }> }) { return <GuidePage slug={await getSlug(params)} locale="en" />; }
